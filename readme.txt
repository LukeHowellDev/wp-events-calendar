...
Tags: events, calendar, date, time, admin, dashboard
...
Events Calendar is a versatile calendar for your WordPress site with many useful functions to keep track of your events.

== Description ==

Events Calendar is a versatile calendar for your WordPress site with many useful functions to keep track of your events.

Uses calendar class from coreyworrell.com/calendar.
...
1. Screenshots will be coming soon.

== Upgrade Notice ==

= 7.0 =
* Complete rewrite of the plugin using the latest WordPress standards.
...
* Fixed Links in Javascript code to rï¿½fresh calendar when permalinks issues
